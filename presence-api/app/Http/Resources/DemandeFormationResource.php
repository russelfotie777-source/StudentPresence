    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'etudiant' => $this->whenLoaded('etudiant', fn () => [
                ...
                'departement_id' => $this->etudiant->filiere?->departement_id,
                'formation' => $this->etudiant->formation?->value,
            ]),
            'salle_cible' => $this->whenLoaded('salleCible', fn () => $this->salleCible ? [
                'id' => $this->salleCible->id,
                'nom' => $this->salleCible->nom,
                'filiere' => $this->salleCible->filiere?->nom,
                'niveau' => $this->salleCible->filiere?->niveau?->nom,
            ] : null),
            'motif' => $this->motif,
