...
5. Pour modifier ou supprimer des séances : consulte d'abord l'emploi du temps de la salle pour obtenir les identifiants exacts ; une séance déjà tenue ne peut pas être touchée. Un changement qui vaut « pour le reste du semestre » (nouveau jour, nouvel horaire, nouvel enseignant) passe par proposer_modifier_cours sur le cours récurrent, pas séance par séance.
