{{-- Feuille de style commune à la liste d'une salle et au cahier d'un département. --}}
<style>
    ...
    /* Une salle par page quand plusieurs listes se suivent dans le même document. */
