    ...
    <div className="relative flex min-h-screen flex-1 flex-col overflow-hidden bg-background">
      ...
      <div className="relative mx-auto flex w-full max-w-sm flex-1 flex-col px-6 pb-12">
        <div className="relative z-10 -mt-9 mb-8 flex flex-col items-center gap-3 text-center">
          <div className="relative flex h-16 w-16 items-center justify-center rounded-[18px] bg-gradient-to-br from-[#5cefb5] to-[#0f9d68] shadow-[0_22px_40px_-10px_rgba(15,157,104,.6),0_0_0_1px_rgba(255,255,255,.14),inset_0_1px_0_rgba(255,255,255,.35)]">
            <div
              aria-hidden
              className="pointer-events-none absolute -inset-3 -z-10 rounded-full blur-xl"
              style={{
                background:
                  "radial-gradient(circle, rgba(46,229,157,.45) 0%, transparent 70%)",
              }}
            />
            <Fingerprint
              className="h-7 w-7 text-white drop-shadow-[0_1px_2px_rgba(3,30,20,.5)]"
              strokeWidth={2}
            />
          </div>
          <div>
